#!/bin/bash
# StarWAM LIBERO feature-conditioned Wan2.2 training on a single node with 8 GPUs.
set -euo pipefail
...
RECIPE=${RECIPE:-examples/libero/configs/recipes/starwam_libero_feature_conditioned_wan22_5b.yaml}
...
cat <<EOF
[launch] mode: StarWAM LIBERO feature-conditioned Wan2.2 single-node 8-GPU
